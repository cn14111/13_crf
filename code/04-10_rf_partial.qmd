...
Today, we'll explore another model that addresses multicollinearity: **random forest**.  
...
supervised is giving a **y** variable whereas as unsupervised is **not having a y variable**
...
mtry = 25, and trees = 443

##Based on R2, we would choose
mtry = 22, and trees = 113
...
rmse is lower in train set and higher in test set
rsq is higher in train set and lower in test set
